...
<img src="https://github.com/adaptlearning/documentation/blob/master/04_wiki_assets/plug-ins/images/blank01.png" alt="sample newblank component">  

Its purpose is to maintain a blank area among other visible components. [Visit the **Blank** wiki](https://github.com/adaptlearning/adapt-newblank/wiki) for more information about its functionality and for explanations of key properties.   
...
The attributes listed below are used in *components.json* to configure **Blank**, and are properly formatted as JSON in [*example.json*](https://github.com/adaptlearning/adapt-newblank/blob/master/example.json). 

### Attributes

[**core model attributes**](https://github.com/adaptlearning/adapt_framework/wiki/Core-model-attributes): These are inherited by every Adapt component. [Read more](https://github.com/adaptlearning/adapt_framework/wiki/Core-model-attributes).

**_component** (string): This value must be: `newblank`.
...
**Author / maintainer:** Adapt Core Team with [contributors](https://github.com/adaptlearning/adapt-newblank/graphs/contributors)  
